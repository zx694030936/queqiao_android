 ...
 */
public class ChangeQQActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected View initContentLayout() {
        return View.inflate(mActivity, R.layout.activity_userinfo_changeqq,null);
    }

    @Override
    protected void initTitle() {
        TextView tv_title = (TextView) mTitleView.findViewById(R.id.tv_title);
        tv_title.setText("QQ号码");
    }
    ...
    public static void intent(Activity activity, String data) {
        ...
        intent.setClass(activity, ChangeQQActivity.class);
