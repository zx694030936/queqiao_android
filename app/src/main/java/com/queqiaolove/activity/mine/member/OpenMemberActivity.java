...
public class OpenMemberActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected View initContentLayout() {
        return View.inflate(mActivity, R.layout.activity_openmember,null);
    }

    @Override
    protected void initTitle() {
        TextView tv_title = (TextView) mTitleView.findViewById(R.id.tv_title);
        tv_title.setText("开通"+title+"会员");
    }
    ...
    public static void intent(Activity activity, String data) {
        ...
        intent.setClass(activity, OpenMemberActivity.class);
