 ...
 */
public class LoveManifestoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected View initContentLayout() {
        return View.inflate(mActivity, R.layout.activity_lovemanifesto_userinfo,null);
    }

    @Override
    protected void initTitle() {
        TextView tv_title = (TextView) mTitleView.findViewById(R.id.tv_title);
        tv_title.setText("爱情宣言");
    }
    ...
    public static void intent(Activity activity, String data) {
        ...
        intent.setClass(activity, LoveManifestoActivity.class);
