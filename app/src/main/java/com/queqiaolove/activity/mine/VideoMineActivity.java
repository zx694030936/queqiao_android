 ...
 */
public class VideoMineActivity extends BaseActivity implements View.OnClickListener, PullToRefreshLayout.OnRefreshListener {
    ...
    protected View initContentLayout() {
        return View.inflate(mActivity, R.layout.activity_myvideo_mine,null);
    }
    ...
    protected ContentPage.RequestState onLoad() {
        gv_pulltofresh.setAdapter(new MyVideoGvAdapter(mActivity));
