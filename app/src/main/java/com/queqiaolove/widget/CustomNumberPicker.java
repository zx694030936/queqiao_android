...
public class CustomNumberPicker extends android.widget.NumberPicker {
    ...
    public CustomNumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDividerColor = attributesArray.getColor(R.styleable.CustomNumberPicker_np_dividerColor, mDividerColor);
        mFormatter = attributesArray.getString(R.styleable.CustomNumberPicker_np_formatter);
        mFocusable = attributesArray.getBoolean(R.styleable.CustomNumberPicker_np_focusable, mFocusable);
        mIsHorizontal = attributesArray.getBoolean(R.styleable.CustomNumberPicker_np_horizontal, mIsHorizontal);
        mMax = attributesArray.getInt(R.styleable.CustomNumberPicker_np_max, mMax);
        mMin = attributesArray.getInt(R.styleable.CustomNumberPicker_np_min, mMin);
        mTextColor = attributesArray.getColor(R.styleable.CustomNumberPicker_np_textColor, mTextColor);
        mTextSize = attributesArray.getDimension(R.styleable.CustomNumberPicker_np_textSize, mTextSize);
        mTypeface = Typeface.create(attributesArray.getString(R.styleable.CustomNumberPicker_np_typeface), Typeface.NORMAL);
        mWidth = attributesArray.getFloat(R.styleable.CustomNumberPicker_np_width, 0);
        mHeight = attributesArray.getFloat(R.styleable.CustomNumberPicker_np_height, 0);
