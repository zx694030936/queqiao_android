...
public class SendInviteCodeDialog extends Dialog implements View.OnClickListener {
    ...
    public SendInviteCodeDialog(Activity context) {
        //构造方法中传入一个主题，去除dialog的默认背景
        super(context, R.style.dialog_style_sendinvite);
        mActivity = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_send_invitecode);
