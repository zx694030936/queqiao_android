 ...
 */
public class HorizontalLiveBulletLvAdapter extends BaseAdapter {
    private final Activity mActivity;

    public HorizontalLiveBulletLvAdapter(Activity activity) {
        mActivity = activity;
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        View v =  View.inflate(mActivity, R.layout.lvitem_bullet_horizontallive,null);
        return v;
    }
