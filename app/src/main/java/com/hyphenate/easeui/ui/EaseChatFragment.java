...
/**
 * you can new an imEaseChatFragment to use or you can inherit it to expand.
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    protected static final String TAG = "imEaseChatFragment";
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        ...
        for (EMMessage message : messages) {
            ...
            Log.w("txtBody.getMessage()","txtBody.getMessage()"+txtBody.getMessage());
